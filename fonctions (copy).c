...
int CollitionParfaitePerso(SDL_Surface *MaskSurface,Personne perso){
	int a =0;
	a= CollitionParfaite(MaskSurface,perso.position.x+25,perso.position.y-18)+CollitionParfaite(MaskSurface,perso.position.x,perso.position.y+25-20)+CollitionParfaite(MaskSurface,perso.position.x+25,perso.position.y+50-22)+CollitionParfaite(MaskSurface,perso.position.x+50,perso.position.y+5);
	return a;
}
...
void jouer(SDL_Surface *ecran, Image jouerB,Image* T_h,Image* T_b){
	...
	MaskSurface=IMG_Load("fond_niv_1.025.png");
									...
									case SDL_KEYDOWN:
										switch(eventniv.key.keysym.sym){
											case SDLK_ESCAPE:
												...
												break;
											case SDLK_RIGHT:
												deplacerPerso(&Joueur, 10,1);
												if (CollitionParfaitePerso(MaskSurface,Joueur)!=0){
													deplacerPerso(&Joueur, 10,2);
												}
												break;
											case SDLK_LEFT:
												deplacerPerso(&Joueur, 10,2);
												...
												break;
											case SDLK_DOWN:
												deplacerPerso(&Joueur, 10,3);
												if (CollitionParfaitePerso(MaskSurface,Joueur)!=0){
													deplacerPerso(&Joueur, 10,4);
												}
												break;
											case SDLK_UP:
												deplacerPerso(&Joueur, 10,4);
